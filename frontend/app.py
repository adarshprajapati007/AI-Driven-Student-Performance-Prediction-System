...
API_URL = "[https://ai-driven-student-performance-prediction.onrender.com/api/predict](https://ai-driven-student-performance-prediction.onrender.com/api/predict)"
